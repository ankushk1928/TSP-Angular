...
export class MentorService {
  ...
  private baseUrl = `${environment.mentorUrl}/api/v1/mentor`;
  private skillUrl = `${environment.mentorUrl}/api/v1/skill/get-all-skills`;
  private categoriesUrl = `${environment.mentorUrl}/api/v1/category/get-all-categories`;
